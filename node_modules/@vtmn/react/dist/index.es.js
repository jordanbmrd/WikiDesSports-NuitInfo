...
var VtmnIcon = function (_a) {
    ...
    return (jsx("span", __assign({ className: "vtmx-".concat(value, " ").concat(className ? className : ''), style: __assign({ fontSize: size, color: color
                ? "var(--vtmn-color_".concat(color, ")")
                : "var(--vtmn-semantic-color_".concat(retrieveSemanticColor(variant), ")") }, style) }, props), void 0));
};
var MemoVtmnIcon = React.memo(VtmnIcon);
MemoVtmnIcon.displayName = 'VtmnIcon';

var VtmnButton = React.forwardRef(function (_a, ref) {
    var _b = _a.variant, variant = _b === void 0 ? 'primary' : _b, _c = _a.size, size = _c === void 0 ? 'medium' : _c, iconLeft = _a.iconLeft, iconRight = _a.iconRight, iconAlone = _a.iconAlone, children = _a.children, className = _a.className, props = __rest(_a, ["variant", "size", "iconLeft", "iconRight", "iconAlone", "children", "className"]);
    return (jsxs("button", __assign({ ref: ref, className: "vtmn-btn vtmn-btn_variant--".concat(variant, " vtmn-btn_size--").concat(size, " ").concat(className ? className : '', " ").concat(!iconAlone && iconLeft ? 'vtmn-btn--icon-left' : '', " ").concat(!iconAlone && iconRight ? 'vtmn-btn--icon-right' : '', " ").concat(iconAlone ? 'vtmn-btn--icon-alone' : '') }, props, { children: [!iconAlone && iconLeft && (jsx(MemoVtmnIcon, { value: iconLeft, style: { color: 'inherit', fontSize: 'inherit' } }, void 0)), iconAlone ? (jsx(MemoVtmnIcon, { value: iconAlone, style: { color: 'inherit', fontSize: 'inherit' } }, void 0)) : (children), !iconAlone && iconRight && (jsx(MemoVtmnIcon, { value: iconRight, style: { color: 'inherit', fontSize: 'inherit' } }, void 0))] }), void 0));
});
var MemoVtmnButton = React.memo(VtmnButton);
MemoVtmnButton.displayName = 'VtmnButton';

var css_248z$5 = ".vtmn-checkbox[type='checkbox']{\n  position:absolute;\n  opacity:0.01;\n}\n\n.vtmn-checkbox[type='checkbox'] + label{\n  position:relative;\n  display:inline-flex;\n  align-items:flex-start;\n  font-family:var(--vtmn-typo_font-family);\n  font-size:var(--vtmn-typo_text-2-font-size);\n  line-height:var(--vtmn-typo_text-2-line-height);\n  cursor:pointer;\n  -webkit-user-select:none;\n     -moz-user-select:none;\n      -ms-user-select:none;\n          user-select:none;\n  color:var(--vtmn-semantic-color_content-primary);\n}\n\n.vtmn-checkbox[type='checkbox'] + label::before{\n  content:'';\n  border-width:0.125rem;\n  border-style:solid;\n  border-radius:0.0625rem;\n  transition:all 0.275s;\n  margin-top:0.1875rem;\n  margin-right:0.6875rem;\n  padding:0.4375rem;\n}\n\n.vtmn-checkbox[type='checkbox']:not(:checked) + label::before{\n  border-color:var(--vtmn-semantic-color_content-inactive);\n}\n\n.vtmn-checkbox[type='checkbox']:not(:focus-visible):not(:checked):not(:disabled):hover\n  + label::before{\n  box-shadow:0 0 0 0.4375rem\n    var(--vtmn-semantic-color_hover-secondary-transparent);\n}\n\n.vtmn-checkbox[type='checkbox']:not(:checked):not(:disabled):active\n  + label::before{\n  box-shadow:0 0 0 0.4375rem\n    var(--vtmn-semantic-color_active-secondary-transparent);\n}\n\n.vtmn-checkbox[type='checkbox']:not(:disabled):focus-visible + label::before{\n  box-shadow:0 0 0 0.25rem var(--vtmn-semantic-color_border-primary-reversed),\n    0 0 0 0.375rem var(--vtmn-semantic-color_border-primary);\n}\n\n.vtmn-checkbox[type='checkbox']:checked + label::before{\n  background-color:var(--vtmn-semantic-color_content-active);\n  border-color:var(--vtmn-semantic-color_content-active);\n}\n\n.vtmn-checkbox[type='checkbox']:not(:focus-visible):checked:not(:disabled):hover\n  + label::before{\n  box-shadow:0 0 0 0.4375rem\n    var(--vtmn-semantic-color_hover-primary-transparent);\n}\n\n.vtmn-checkbox[type='checkbox']:checked:not(:disabled):active + label::before{\n  box-shadow:0 0 0 0.4375rem\n    var(--vtmn-semantic-color_active-primary-transparent);\n}\n\n.vtmn-checkbox[type='checkbox'] + label::after{\n  content:'';\n  -webkit-mask:url(\"data:image/svg+xml;charset=utf-8, <svg width='18' height='18' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'><path d='M5.80351 10.8L14.2875 2.31484L12.5907 0.618038L5.80351 7.40644L2.40871 4.01164L0.711914 5.70844L5.80351 10.8Z'/></svg>\");\n          mask:url(\"data:image/svg+xml;charset=utf-8, <svg width='18' height='18' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'><path d='M5.80351 10.8L14.2875 2.31484L12.5907 0.618038L5.80351 7.40644L2.40871 4.01164L0.711914 5.70844L5.80351 10.8Z'/></svg>\");\n  -webkit-mask-size:cover;\n          mask-size:cover;\n  position:absolute;\n  height:1.125rem;\n  width:1.125rem;\n  top:0.4375rem;\n  left:0.125rem;\n  background-color:var(--vtmn-semantic-color_content-primary-reversed);\n  transition:all 0.2s;\n}\n\n.vtmn-checkbox[type='checkbox'].vtmn-checkbox--indeterminate + label::after{\n  content:'';\n  -webkit-mask:url(\"data:image/svg+xml;charset=utf-8, <svg width='23' height='23' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'><path d='M3.333 7.333h9.334v1.334H3.333V7.333z' stroke-width='10'/></svg>\");\n          mask:url(\"data:image/svg+xml;charset=utf-8, <svg width='23' height='23' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'><path d='M3.333 7.333h9.334v1.334H3.333V7.333z' stroke-width='10'/></svg>\");\n  -webkit-mask-size:cover;\n          mask-size:cover;\n  height:1.4375rem;\n  width:1.4375rem;\n  top:0.1875rem;\n  left:0;\n}\n\n.vtmn-checkbox[type='checkbox']:not(:checked) + label::after{\n  opacity:0;\n  transform:scale(0) rotate(45deg);\n}\n\n.vtmn-checkbox[type='checkbox']:checked + label::after{\n  opacity:1;\n  transform:scale(1) rotate(0);\n}\n\n.vtmn-checkbox[type='checkbox']:disabled + label{\n  opacity:var(--vtmn-opacity_disabled-state);\n  cursor:not-allowed;\n}\n\n@media screen and (min-width: 600px) and (max-width: 899px){\n}\n\n@media screen and (min-width: 900px) and (max-width: 1199px){\n}\n\n@media screen and (min-width: 1200px) and (max-width: 1799px){\n}\n\n@media screen and (min-width: 1800px){\n}\n";
styleInject(css_248z$5);

var VtmnCheckbox = function (_a) {
    var identifier = _a.identifier, labelText = _a.labelText, checked = _a.checked, disabled = _a.disabled, props = __rest(_a, ["identifier", "labelText", "checked", "disabled"]);
    return (jsxs("div", { children: [jsx("input", __assign({ className: "vtmn-checkbox", type: "checkbox", id: identifier, defaultChecked: checked, disabled: disabled }, props), void 0), jsx("label", __assign({ htmlFor: identifier }, { children: labelText }), void 0)] }, void 0));
};
var MemoVtmnCheckbox = React.memo(VtmnCheckbox);
